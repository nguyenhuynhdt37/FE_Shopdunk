    ...
    <Link to="/iphone">
      <div className="box-item bg-white">
        <div className="box-image pt-10 flex justify-center">
          <img
            src="https://shopdunk.com/images/thumbs/0024430_iphone-13-128gb_240.png"
            alt=""
            className="img object-cover w-full"
          />
        </div>
        <div className="info-product mt-10 mb-12 text-2.5xl font-bold flex ">
        ...
        <div className="product-price flex text-2xl items-center pb-2">
          ...
          <div className="percent-discount text-2xl text-zinc-400">-45%</div>
        </div>
      </div>
    </Link>
  )
